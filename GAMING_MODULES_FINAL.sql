-- GAMING ADDICTION RECOVERY MODULES - Run this SQL after the main tracks system
-- Evidence-based modules specifically designed for gaming addiction recovery (WHO Gaming Disorder)
