-- Marijuana/Cannabis Recovery Track - Evidence-Based Modules
-- Based on latest research in cannabis use disorder, THC dependence, and modern high-potency cannabis

-- Insert marijuana-specific modules with comprehensive, evidence-based content
