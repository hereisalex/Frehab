-- Methamphetamine Recovery Track - Evidence-Based Modules
-- Based on latest research in stimulant addiction treatment and neurotoxicity recovery

-- Insert methamphetamine-specific modules with comprehensive, evidence-based content
