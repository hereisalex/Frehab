...
export default function CocaineDrugTestingPage() {
  const [showDisclaimer, setShowDisclaimer] = useState(true)

  return (
    <div className="min-h-screen bg-slate-50">
      {showDisclaimer && (
        <ClinicalDisclaimer id="cocaine-drug-testing" />
      )}
        ...
        <div className="bg-white rounded-xl shadow-lg border border-neutral-200 p-8">
          ...
          <div className="prose prose-slate max-w-none">
            <p className="text-lg text-slate-600 mb-6">
              Drug testing for cocaine is commonly used in recovery programs, workplace 
              settings, and medical monitoring. Understanding how these tests work can 
              help you navigate recovery and make informed decisions.
            </p>

            <h2 className="text-2xl font-semibold text-slate-700 mt-8 mb-4">
              Types of Cocaine Drug Tests
            </h2>
            ...
            <div className="space-y-6 mb-8">
              <div className="border-l-4 border-blue-500 pl-4">
                ...
                <ul className="list-disc pl-4 space-y-1 text-slate-600">
                  ...
                  <li>Detects cocaine metabolites for 2-4 days after use</li>
                  <li>Can detect benzoylecgonine (primary metabolite)</li>
              ...
              <div className="border-l-4 border-blue-500 pl-4">
                ...
                <ul className="list-disc pl-4 space-y-1 text-slate-600">
                  ...
                  <li>Detects recent use (hours to 1-2 days)</li>
            ...
            <div className="bg-yellow-50 p-6 rounded-lg mb-6">
              <p className="text-yellow-800">
                Detection times vary depending on frequency of use, dosage, individual 
                metabolism, and other factors. Always consult with healthcare providers 
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="bg-green-50 p-6 rounded-lg">
                ...
                <ul className="list-disc pl-4 space-y-1 text-green-700">
                  <li>Urine: 2-3 days</li>
                  <li>Blood: 1-2 days</li>
                  <li>Saliva: 1-2 days</li>
              ...
              <div className="bg-purple-50 p-6 rounded-lg">
                ...
                <ul className="list-disc pl-4 space-y-1 text-purple-700">
                  <li>Urine: 5-7 days</li>
                  <li>Blood: 2-3 days</li>
                  <li>Saliva: 2-3 days</li>
                  <li>Hair: Up to 90 days</li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-orange-50 p-6 rounded-lg mb-8">
              ...
              <ul className="list-disc pl-4 space-y-2 text-orange-700">
                <li>Certain local anesthetics</li>
                <li>Some cold medications</li>
                <li>Certain antibiotics</li>
                <li>Some herbal supplements</li>
                <li>Over-the-counter medications</li>
                <li>Foods containing coca leaves</li>
              </ul>
            </div>
