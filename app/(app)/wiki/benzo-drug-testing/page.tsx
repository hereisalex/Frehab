...
export default function BenzoDrugTestingPage() {
  const [showDisclaimer, setShowDisclaimer] = useState(true)

  return (
    <div className="min-h-screen bg-slate-50">
      {showDisclaimer && (
        <ClinicalDisclaimer id="benzo-drug-testing" />
      )}
        ...
        <div className="bg-white rounded-xl shadow-lg border border-neutral-200 p-8">
          ...
          <div className="prose prose-slate max-w-none">
            <p className="text-lg text-slate-600 mb-6">
              Drug testing for benzodiazepines is commonly used in recovery programs, 
            ...
            <div className="space-y-6 mb-8">
              <div className="border-l-4 border-blue-500 pl-4">
                ...
                <ul className="list-disc pl-4 space-y-1 text-slate-600">
                  ...
                  <li>Detects benzodiazepines for 3-7 days after use</li>
                  <li>Can detect specific benzodiazepines</li>
              ...
              <div className="border-l-4 border-blue-500 pl-4">
                ...
                <ul className="list-disc pl-4 space-y-1 text-slate-600">
                  ...
                  <li>Less common for benzodiazepines</li>
            ...
            <div className="bg-yellow-50 p-6 rounded-lg mb-6">
              <p className="text-yellow-800">
                Detection times vary depending on the specific benzodiazepine, frequency 
                of use, dosage, individual metabolism, and other factors. Always consult 
                with healthcare providers for specific information about your situation.
              </p>
            </div>

            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="bg-green-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-green-800 mb-3">Short-Acting Benzodiazepines</h3>
                <ul className="list-disc pl-4 space-y-1 text-green-700">
                  <li>Alprazolam (Xanax): 2-4 days</li>
                  <li>Lorazepam (Ativan): 3-6 days</li>
                  <li>Oxazepam (Serax): 2-8 days</li>
                  <li>Triazolam (Halcion): 1-2 days</li>
                  <li>Midazolam (Versed): 1-2 days</li>
                </ul>
              </div>
              
              <div className="bg-purple-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-purple-800 mb-3">Long-Acting Benzodiazepines</h3>
                <ul className="list-disc pl-4 space-y-1 text-purple-700">
                  <li>Diazepam (Valium): 7-10 days</li>
                  <li>Clonazepam (Klonopin): 5-9 days</li>
                  <li>Chlordiazepoxide (Librium): 5-10 days</li>
                  <li>Flurazepam (Dalmane): 7-10 days</li>
                  <li>Nitrazepam (Mogadon): 5-8 days</li>
                </ul>
              </div>
            </div>
