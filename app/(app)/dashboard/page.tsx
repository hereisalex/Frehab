        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="bg-orange-100 border border-orange-300 rounded-lg px-3 py-2">
              <span className="text-orange-800 text-sm font-medium">Alpha</span>
            </div>
          </div>
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-blue-800 text-sm">
              💡 <strong>Alpha Feedback:</strong> We&apos;re actively improving Frehab. If you encounter any issues or have suggestions, 
              please let us know through the community or contact us directly.
            </p>
          </div>
        </div>
      </div>
