#!/usr/bin/env python3
"""
Create a basic PDF worksheet using a simple approach
"""

import os

def create_worksheet():
    """Create the worksheet content and save as HTML for PDF conversion"""
    
    # Create output directory
    os.makedirs("public/worksheets", exist_ok=True)
    
    # HTML content with proper styling for PDF
    html_content = """
<!DOCTYPE html>
<html>
<head>
    ...
    <style>
        ...
        hr { border: none; border-top: 2px solid #2c5aa0; margin: 20px 0; }
    </style>
</head>
<body>
    ...
    # Write HTML file
    with open("alcohol-free-celebrations-worksheet.html", "w", encoding="utf-8") as f:
        f.write(html_content)
    
    print("✅ HTML worksheet created: alcohol-free-celebrations-worksheet.html")
    print("\n📄 To convert to PDF:")
    print("1. Open alcohol-free-celebrations-worksheet.html in your browser")
    print("2. Press Ctrl+P (or Cmd+P on Mac)")
    print("3. Choose 'Save as PDF' as destination")
    print("4. Set margins to 'Minimum' for best fit")
    print("5. Save as 'alcohol-free-celebrations.pdf' in public/worksheets/")
    print("\n🎯 The worksheet is ready for use!")
